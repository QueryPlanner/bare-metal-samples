...
async def fetch_image_tool(image_filename: str, tool_context: ToolContext) -> str:
    ...
    Args:
        ...
        image_filename: The exact filename of the meme image (e.g., 'Doge.jpg', '10-Guy.jpg'). 
                       ...
                       This MUST be obtained from the 'image_filename' field of the 'meme_info_tool'.
    ...
    if not image_path.exists():
        ...
        return f"Error: Meme template image '{image_filename}' not found in {images_dir}. Please ensure you are using the 'image_filename' exactly as provided by 'meme_info_tool'."
